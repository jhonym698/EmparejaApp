...
public class MedioActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idOriginales= new int[]{R.id.btn1,R.id.btn2,R.id.btn3,R.id.btn4,R.id.btn5,R.id.btn6};
    ...
    private void terminarJuego() {
        ...
        try{
            ...
            AlertDialog.Builder ventana=new AlertDialog.Builder(MedioActivity.this);
            ...
            ventana.setPositiveButton("Compartir en redes", new DialogInterface.OnClickListener() {
                ...
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent=new Intent(MedioActivity.this,InicioActivity.class);
    ...
    private void abrirRedes() {
        ...
        AlertDialog.Builder ventanaRedes= new AlertDialog.Builder(MedioActivity.this);
