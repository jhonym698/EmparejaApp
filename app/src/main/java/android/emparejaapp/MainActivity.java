...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int imagenes[]={R.drawable.uno,R.drawable.dos,R.drawable.tres,R.drawable.cuatro};
    int arrayImage[] = new int[8];
    int seleccionado1=0;
    int seleccionado2=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idOriginales= new int[]{R.id.btn1,R.id.btn2,R.id.btn3,R.id.btn4,R.id.btn5,R.id.btn6,R.id.btn7,R.id.btn8};
    ...
    private void abrirRedes() {
        ...
        AlertDialog.Builder ventanaRedes= new AlertDialog.Builder(MainActivity.this);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn5:
                btn5.setImageResource(arrayImage[4]);
                btn5.setId(arrayImage[4]);
                if (seleccionado1==0){
                    seleccionado1=arrayImage[4];
                }else{
                    seleccionado2=arrayImage[4];
                    comprobarID();
                }
                break;

            case R.id.btn6:
                btn6.setImageResource(arrayImage[5]);
                btn6.setId(arrayImage[5]);
                if (seleccionado1==0){
                    seleccionado1=arrayImage[5];
                }else{
                    seleccionado2=arrayImage[5];
                    comprobarID();
                }
                break;

            case R.id.btn7:
                btn7.setImageResource(arrayImage[6]);
                btn7.setId(arrayImage[6]);
                if (seleccionado1==0){
                    seleccionado1=arrayImage[6];
                }else{
                    seleccionado2=arrayImage[6];
                    comprobarID();
                }
                break;

            case R.id.btn8:
                btn8.setImageResource(arrayImage[7]);
                btn8.setId(arrayImage[7]);
                if (seleccionado1==0){
                    seleccionado1=arrayImage[7];
                }else{
                    seleccionado2=arrayImage[7];
                    comprobarID();
                }
    ...
    private void ocultarImagen() {
        ...
        btn5.setImageResource(R.drawable.carta);
        btn6.setImageResource(R.drawable.carta);
        btn7.setImageResource(R.drawable.carta);
        btn8.setImageResource(R.drawable.carta);
    }
    ...
    private void retornarID() {
        ...
        btn5.setId(idOriginales[4]);
        btn6.setId(idOriginales[5]);
        btn7.setId(idOriginales[6]);
        btn8.setId(idOriginales[7]);
    }
}
